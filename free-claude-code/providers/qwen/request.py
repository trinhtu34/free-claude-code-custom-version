"""Request builder for Qwen provider."""
...
def build_request_body(
    ...
    logger.debug(
        "QWEN_REQUEST: conversion start model={} msgs={}",
    ...
    # Qwen-specific max_tokens: cap against nim.max_tokens
    ...
    # Qwen-specific temperature/top_p: fall back to NIM defaults if request didn't set
    ...
    # Qwen-specific stop sequences fallback
    ...
    logger.debug(
        "QWEN_REQUEST: conversion done model={} msgs={} tools={}",
        body.get("model"),
